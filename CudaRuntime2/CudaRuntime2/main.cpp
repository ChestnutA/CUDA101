...
int main() {
	...
	for (int i = 0; i < MAX_ITERATIONS; i++) {
		...
		//cudaMeanShift_sharedMemory_2D_wrapper_optimized(outputData_ptr_device, inputData_ptr_device, originalPoints_ptr_device, datasetDim, vecDim, gridDim, blockDim);
		//cudaMeanShift_2D_optimized_wrapper(outputData_ptr_device, inputData_ptr_device, originalPoints_ptr_device, datasetDim, vecDim, gridDim, blockDim);
